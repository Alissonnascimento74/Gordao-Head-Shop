...
export const MOCK_ORDERS: Order[] = [
  {
    ...
    items: [
      { productId: "000298-1", productName: "Bag Vault pequena", quantity: 1, unitPrice: 110.0 },
      { productId: "mock-seda-king", productName: "Seda King Size Extra", quantity: 2, unitPrice: 12.0 },
    ],
    total: 134.0,
  ...
  },
  {
    ...
    items: [{ productId: "000075", productName: "Case Rick and Morty", quantity: 1, unitPrice: 80.0 }],
    total: 80.0,
    status: "pago",
  ...
  },
  {
    ...
    items: [
      { productId: "mock-tabaco-premiado", productName: "Tabaco premiado 50g", quantity: 1, unitPrice: 32.0 },
      { productId: "000303-1", productName: "Piteira de vidro", quantity: 1, unitPrice: 18.0 },
    ],
    total: 50.0,
    status: "separando",
  ...
  },
  {
    ...
    items: [{ productId: "000103", productName: "Alça puff", quantity: 1, unitPrice: 50.0 }],
    total: 50.0,
    status: "despachado",
  ...
  },
  {
    ...
    items: [{ productId: "000246-1", productName: "Haste de limpeza", quantity: 3, unitPrice: 5.0 }],
    total: 15.0,
    status: "pago",
  ...
  },
  {
    ...
    items: [{ productId: "000046-1", productName: "Bandeja Narcos", quantity: 1, unitPrice: 65.0 }],
    total: 65.0,
    status: "despachado",
